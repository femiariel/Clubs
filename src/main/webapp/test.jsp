...
<body>
<form class="form-signin w-100 m-auto text-center"  name='form_connexion' method='POST' >
    
    <h1 class="h3 mb-3 fw-normal"> Connexion</h1>
   
    <div class="form-floating">
      <input type="email" class="form-control" id="floatingInput" placeholder="name@example.com" name="l_mail">
    ...
    <p class="mt-5 mb-3 text-muted">Vous n'avez pas de compte? <a href="">S'inscrire </a></p>
  </form>
