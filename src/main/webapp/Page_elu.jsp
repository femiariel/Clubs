    ...
    <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-body-tertiary sidebar collapse">
      <div class="position-sticky pt-3 sidebar-sticky">
        <ul class="nav flex-column">
          ...
          <li class="nav-item">
            <a class="nav-link active" aria-current="page" href="#page_elu.jsp">
          ...
          <li class="nav-item">
            <a class="nav-link" href="Visualisationcommune.jsp">
             ...
             <li class="nav-item">
            <a class="nav-link" href="Page_consultation_elu.jsp">
              <span data-feather="file" class="align-text-bottom"></span>
				...
				<div class="carousel carousel-dark slide justify-content-center" style:"carousel-dark-caption-opacity:100">
					<div class="carousel-inner">
		                <div class="carousel-item active">
		                   <!--  --><img src="images/image_sports_1.png" class="d-block w-100">
		                    <div class="carousel-caption d-none d-md-block">
		                        <h2 style="text-align: center">
		                            Informations
		                        </h2>
		                        <p style="text-align:center;margin:1em">
		                            Cette plateforme a été développée pour faciliter l’accès à un ensemble d’informations relatives aux clubs sportifs (affiliés) et aux licenciés des différentes fédérations sportives en France. Il existe plus d’une centaine de fédérations sportives et plus de 100 000 clubs de sport répartis sur le territoire.
		                        </p>
		                    </div>
		                </div>
					</div>
