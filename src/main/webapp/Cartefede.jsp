...
<head>
   ...
   <title>Clubs en fonction de la région</title>
   <link rel="stylesheet" href="https://unpkg.com/leaflet@1.9.3/dist/leaflet.css"
     integrity="sha256-kLaT2GOSpHechhsozzB+flnD+zUyjE2LlfWPgU04xyI="
     crossorigin=""/>
     <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/bootstrap/5.0.2/css/bootstrap.min.css" integrity="sha512-z7BHTZfSgeZByK43QOicR8a0xGJQy6QUANcIBKfom0AG+Z0U/MZCvd/LX6F0j6iOVLdrjKMOxwJR0eezvrcO+w==" crossorigin="anonymous" referrerpolicy="no-referrer" />
...
<body> 
   ...
   <form method="post" action="./ServClubRegion">
     <p>
